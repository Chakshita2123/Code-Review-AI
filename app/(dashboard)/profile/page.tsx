    ...
    <main className="mx-auto max-w-4xl p-6 lg:p-8">
      ...
      <div className="mb-8 flex flex-col items-center sm:flex-row sm:items-start sm:gap-6">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="mt-1 text-zinc-400">{profile.email}</p>
      ...
      <div className="mb-10 grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5">
          ...
          <p className="mt-3 text-3xl font-bold text-white">{stats.favoritesCount}</p>
        </div>
      </div>
      ...
      <div className="grid gap-10 md:grid-cols-2">
        ...
        <section>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-medium text-white">{activity.language} Review</span>
                      </div>
            ...
            <div className="border-t border-zinc-800/50 bg-zinc-950/30 p-3 text-center">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5">
            <dl className="space-y-4">
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                ...
                <dd className="text-sm font-medium text-white">{profile.name}</dd>
              </div>
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                <dt className="text-sm text-zinc-400">Email</dt>
                <dd className="text-sm font-medium text-white">{profile.email}</dd>
              </div>
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                <dt className="text-sm text-zinc-400">Auth Provider</dt>
                <dd className="flex items-center gap-1.5 text-sm font-medium text-white capitalize">
              ...
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                ...
                <dd className="text-sm font-medium text-white">{formatReviewDate(profile.createdAt)}</dd>
              </div>
              <div className="flex items-center justify-between">
                <dt className="text-sm text-zinc-400">Last Review</dt>
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            {achievements.locked.map((ach) => (
              <div
                key={ach.id}
                title={ach.description}
                className="group relative flex flex-col items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 text-center grayscale transition-all hover:grayscale-0 hover:border-zinc-700"
              >
